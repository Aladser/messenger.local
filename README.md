...
* Добавлена возможность пересылчки не своих сообщенйи из чата
* Если вебсокет недоступен, то перед отправкой сообщения вылезет предупреждение. По умолчанию вебсокета прослушивается на localhost
