...
* Сайт сделан на основе **MVC-фреймворка** в *Ubuntu 22.02*.
* Бэк-часть: **PHP 7.4**.
...
* Для полной работы сайта нужно запустить бэк вебсокета: запустить скрипт *php chat-server.php*
В окне chat-server пишется лог вебсокета.
