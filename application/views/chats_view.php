<div class='container chat-container'>
    ...
    <div class='options-container pt-2'>
        <div class='option'>
            ...
            <div class='option-img-div'><img src="application/images/profile.png" class='img' title='Профиль'></div>
            <span class='option-name'>Профиль</span>
            </a>
        </div>
        <div class='option'>
            <a href="" class='option-link contact-img-div'>
            <div class='option-img-div'><img src="application/images/settings.png" class='img' title='Настройки'></div>
            <span class='option-name'>Настройки</span>
            </a>
        </div>
        <div class='option'>
            <a href="/Main?logout=true" class='option-link contact-img-div'>
            <div class='option-img-div'><img src="application/images/exit.png" class='img' title='Выход'></div>
