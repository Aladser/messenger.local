<div class='container text-center mt-4'>
    <form class='login-form mx-auto' method="POST" action='' id='login-form'>
        ...
        <input type="email" class="d-block mx-auto btn-width mb-2 p-2" id="login-form__email-input" name='email' placeholder='Почта' required>

        <label for="login-form__password-input" class='text-start btn-width p-1 fw-bolder'>Пароль</label>
        <input type="password" class="d-block mx-auto btn-width mb-3 p-2" id="login-form__password-input" name='password' placeholder='Пароль' required>
