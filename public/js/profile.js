        ...
        fetch('/upload-file', {method: 'POST', body: formData})
            ...
            .then(data => {
                try {
                    ...
                    if (data.image !== '') {
                        profileImageField.src = `${window.location.origin}/public/data/temp/${data.image}?r=${randomNumber++}`;
                    } else {
                        profileImageField.src = `${window.location.origin}/public/images/ava_profile.png`;
                    }
